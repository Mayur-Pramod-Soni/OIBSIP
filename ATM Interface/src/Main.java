...
class Account {
    static int acc_number = 1111; // Start account number
    ...
    void createAcc() {
        ...
        acc_number++; // Increment account number for the next account
    }
}
            ...
            switch (choice) {
                case 1:
                    if (numAccounts < 100) {
                        ...
                        ac[numAccounts] = new Account();
                        ac[numAccounts].createAcc();
                        System.out.print("\033[H\033[2J");
                        System.out.flush();
                        numAccounts++;
                    } else {
                        System.out.println("Maximum account limit reached. Cannot create more accounts.");
                    }
                    break;
                case 2:
                    if (numAccounts > 0) {
                    ...
                    break;
                case 3:
                    System.out.println("Exiting the program. Thank you for using the ATM.");
                    System.exit(0);
                default:
